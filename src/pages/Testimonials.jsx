...
export default function Testimonials() {
  ...
  return (
    <>
      <Helmet>
        <title>Testimonials | Esther Babaoye</title>
        <meta
          name="description"
          content="What clients and collaborators say about working with Esther Babaoye."
        />
        <meta property="og:title" content="Testimonials | Esther Babaoye" />
        <meta
          property="og:description"
          content="Read client reviews and feedback on my web development and scriptwriting services."
        />
      </Helmet>
